...
export const baseMetadata: Metadata = {
  ...
  description:
    "Autoatendimento via QR Code, kanban para a cozinha e gestão completa para o seu bar ou pub. Comece grátis por 14 dias.",
  keywords: [
    "sistema para bar",
    "sistema de pedidos",
    "QR Code cardápio",
...
export function softwareApplicationSchema() {
  return {
    ...
    description:
      "Sistema de pedidos e autoatendimento via QR Code para bares, pubs e restaurantes.",
