...
const securityHeaders = [
  ...
  // Content Security Policy
  {
    ...
    value: [
      ...
      "connect-src 'self' https://admin.publy.tech https://viacep.com.br https://www.google-analytics.com https://analytics.google.com https://region1.google-analytics.com",
