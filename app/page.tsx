  ...
  return (
    <>
      ...
      <section style={{
        ...
        <HeroFade delay={0.7}>
          <div className="mockup-wrapper" style={{ position: "relative", marginTop: 72, maxWidth: 1100, width: "100%", animation: "gridFloat 6s ease-in-out infinite" }}>
            <KanbanMock />
          </div>
        </HeroFade>
      </section>
      ...
      <section style={{ padding: "100px 24px", overflow: "hidden" }}>
        <div className="spotlight-grid" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          ...
          {/* Mock phone */}
          <SlideRight>
            <div className="mockup-wrapper" style={{ display: "flex", justifyContent: "center", position: "relative" }}>
